...
wget https://github.com/3rdEyeOperation/RavenGrid-Installer/raw/master/colors.sh -qO "$INSTALLER_DIR"/colors.sh
...
tar -xf ./*.tar.gz
wget https://github.com/3rdEyeOperation/RavenGrid-Installer/raw/master/mediamtx.yml -qO ~/ots/mediamtx/mediamtx.yml
...
sudo wget https://raw.githubusercontent.com/3rdEyeOperation/RavenGrid-Installer/master/nginx_configs/rabbitmq -qO /etc/nginx/streams-available/rabbitmq
sudo wget https://raw.githubusercontent.com/3rdEyeOperation/RavenGrid-Installer/master/nginx_configs/mediamtx -qO /etc/nginx/streams-available/mediamtx
sudo wget https://raw.githubusercontent.com/3rdEyeOperation/RavenGrid-Installer/master/nginx_configs/ots_certificate_enrollment -qO /etc/nginx/sites-available/ots_certificate_enrollment
sudo wget https://raw.githubusercontent.com/3rdEyeOperation/RavenGrid-Installer/master/nginx_configs/ots_http -qO /etc/nginx/sites-available/ots_http
sudo wget https://raw.githubusercontent.com/3rdEyeOperation/RavenGrid-Installer/master/nginx_configs/ots_https -qO /etc/nginx/sites-available/ots_https
...
sudo mkdir -p /var/www/html/opentakserver_src
sudo chmod a+rw /var/www/html/opentakserver_src
cd /var/www/html/opentakserver_src
...
sudo rm -rf /var/www/html/opentakserver/*
...
sudo wget https://raw.githubusercontent.com/3rdEyeOperation/RavenGrid-Installer/master/rabbitmq.conf -qO /etc/rabbitmq/rabbitmq.conf
